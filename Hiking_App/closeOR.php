...
$data=array();	
$ids=array();
$result1 = mysqli_query($mysqli, "SELECT * FROM route WHERE (latitude >= '$var1' AND latitude <= '$var2') AND (longitude >= '$var3'  OR longitude <= '$var4') AND acos(sin('$var5') * sin(latitude) + cos('$var6') * cos(latitude) * cos(longitude - '$var7')) <= '$var8'");
